...
function CheckAnswer2() {
         document.querySelector("#quiz-question-text").innerText = "YOU GOT IT!"<br> "Through the basic motions of Taekwondo, we learn how to protect ourselves. These are motions that protect myself, not attacking someone.";
